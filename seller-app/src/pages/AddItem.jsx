  ...
  return (
    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <h2 style={{ marginBottom: "2rem", fontSize: "clamp(1.5rem, 5vw, 2rem)" }}>Add New Product</h2>
        ...
        {categories.map((cat) => (
          ...
          <div>
            ...
            <div style={{ 
              ...
              {!productData.hasVariations && (
                <>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1rem", width: "100%", boxSizing: "border-box" }}>
                    <div>
                      <label style={{ display: "block", marginBottom: "0.5rem", fontWeight: "500" }}>
                        Stock Status
                      </label>
