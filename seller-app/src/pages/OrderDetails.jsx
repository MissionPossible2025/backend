...
export default function OrderDetails({ user }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh", width: "100%", maxWidth: "100%", margin: 0, padding: "clamp(0.5rem, 2vw, 1rem)", boxSizing: "border-box", overflowX: "hidden" }}>
      <div style={{ backgroundColor: "rgba(255, 255, 255, 0.1)", padding: "clamp(1rem, 3vw, 2rem)", borderRadius: 12, width: "100%", maxWidth: "1000px", boxSizing: "border-box" }}>
        ...
        <div style={{ marginBottom: "1.25rem", background: "#f8fafc", border: "1px solid #e5e7f0", borderRadius: 12, padding: "1rem", textAlign: 'left' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 200px), 1fr))', gap: '0.75rem', width: '100%', boxSizing: 'border-box' }}>
